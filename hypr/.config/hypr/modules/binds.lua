...
-- TODO: fullscreen and prntscreen
...
hl.bind(mainMod .. " + SHIFT + V", hl.dsp.exec_cmd("cliphist list | rofi -dmenu -no-show-icons false | cliphist decode | wl-copy"))
...
-- TODO: bind=SUPER,TAB,workspace,previous
-- TODO: GROUPS
